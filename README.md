...
| --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) ⭐ 389,186 \| 🐛 6,355 \| 🌐 TypeScript \| 📅 2026-09-08           | Main repository — TypeScript monorepo                                     |
...
| [OpenClaw Changelog](https://github.com/openclaw/openclaw/releases) ⭐ 389,186 \| 🐛 6,355 \| 🌐 TypeScript \| 📅 2026-09-08 | Release notes and version history                                         |
...
➡️ [**VoltAgent/awesome-openclaw-skills**](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,439 | 🐛 5 | 📅 2026-09-05 — 1M+ monthly views, the #1 community skills resource.
...
* [SKILL.md Format Specification](https://github.com/openclaw/clawhub/blob/main/docs/skill-format.md) ⭐ 9,402 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-07 — frontmatter fields, env var declarations, binary dependencies, install spec
* [ClawHub CLI Publishing Tool](https://github.com/openclaw/clawhub) ⭐ 9,402 | 🐛 62 | 🌐 TypeScript | 📅 2026-09-07 — `clawhub publish <path>`, `clawhub inspect <slug>`, versioning, soft-delete/restore
...
| ----------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------- |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 36,888 \| 🐛 9 \| 🌐 TypeScript \| 📅 2026-09-04                                | Browser  | Most-used MCP in OpenClaw; full browser automation |
| [github-mcp](https://github.com/github/github-mcp-server) ⭐ 32,803 \| 🐛 326 \| 🌐 Go \| 📅 2026-09-07                                          | DevOps   | Official GitHub MCP                                |
| [filesystem-mcp](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) ⭐ 90,152 \| 🐛 498 \| 🌐 TypeScript \| 📅 2026-09-03 | System   | Read/write files with explicit path control        |
| [memory-mcp](https://github.com/JamesANZ/memory-mcp) ⭐ 22 \| 🐛 0 \| 🌐 TypeScript \| 📅 2025-12-10                                             | Memory   | Knowledge graph memory                             |
| [brave-search-mcp](https://github.com/brave/brave-search-mcp-server) ⭐ 1,428 \| 🐛 40 \| 🌐 TypeScript \| 📅 2026-09-07                         | Search   | Web search via Brave API                           |
| [fetch-mcp](https://github.com/zcaceres/fetch-mcp) ⭐ 823 \| 🐛 7 \| 🌐 TypeScript \| 📅 2026-03-12                                              | HTTP     | Web fetching and scraping                          |
| [postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 3,277 \| 🐛 90 \| 🌐 Python \| 📅 2026-08-17                                       | Database | Read-only PostgreSQL access                        |
| [slack-mcp](https://mcp.slack.com)                                                                                                              | Comms    | Official Slack MCP                                 |
| [gmail-mcp](https://gmail.mcp.claude.com)                                                                                                       | Email    | Gmail via MCP                                      |

Browse 13,000+ MCP servers at [mcp.so](https://mcp.so) or the [official MCP server directory](https://github.com/modelcontextprotocol/servers) ⭐ 90,152 | 🐛 498 | 🌐 TypeScript | 📅 2026-09-03.
...
| [OpenClaw Windows Hub](https://github.com/openclaw/openclaw-windows-node) ⭐ 2,094 \| 🐛 90 \| 🌐 C# \| 📅 2026-09-08  | Windows         | Windows companion suite for OpenClaw (AI personal assistant)                                                   |
...
| [OpenClaw Android Node](https://docs.openclaw.ai/platforms/android) | Android  | Official Android platform docs; community APK build at [openclaw-android-node-apk](https://github.com/bighamx/openclaw-android-node-apk) ⭐ 57 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-09-08                                                                              |
...
See [nix-openclaw](https://github.com/openclaw/nix-openclaw) ⭐ 712 | 🐛 0 | 🌐 Nix | 📅 2026-09-08 for the community NixOS module.
...
| [NemoClaw](https://github.com/nvidia/nemoclaw) ⭐ 22,404 \| 🐛 636 \| 🌐 TypeScript \| 📅 2026-09-08    | NVIDIA-sandboxed build; GPU-accelerated, fully isolated   | Air-gap ready            |
...
| [Graphiti](https://github.com/getzep/graphiti) ⭐ 30,693 \| 🐛 493 \| 🌐 Python \| 📅 2026-09-06 | Temporal knowledge graph memory              | Complex relational knowledge over time       |
| [MemOS](https://github.com/MemTensor/MemOS) ⭐ 11,228 \| 🐛 66 \| 🌐 TypeScript \| 📅 2026-09-08 | Hierarchical memory OS for LLM agents        | Research-grade memory architecture           |
| [mem0](https://github.com/mem0ai/mem0) ⭐ 64,892 \| 🐛 739 \| 🌐 Python \| 📅 2026-09-08         | Self-improving personalized memory           | Personalization-heavy workflows              |
...
| Resource                                                                                               | Description                                                                                                                   |
| ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| [A2A Protocol Spec](https://github.com/a2aproject/A2A) ⭐ 25,686 \| 🐛 247 \| 🌐 Shell \| 📅 2026-09-04 | Open agent interoperability protocol, initiated by Google                                                                     |
...
| [ClawHub CLI](https://github.com/openclaw/clawhub) ⭐ 9,402 \| 🐛 62 \| 🌐 TypeScript \| 📅 2026-09-07 | Official publishing tool: `clawhub publish`, `clawhub inspect`, versioning, soft-delete/restore                                                |
...
| Tool                                                                                                     | Description                                                                                                                                                                         |
| -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) ⭐ 6,580 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-09-07 | Agent-native LLM router supporting 41+ models, sub-1ms routing latency, USDC payments via x402 on Base and Solana                                                                   |
...
**[OpenClaw](https://github.com/openclaw/openclaw) ⭐ 389,186 | 🐛 6,355 | 🌐 TypeScript | 📅 2026-09-08** — Reference implementation. Choose when: you want the largest skill ecosystem and accept the resource tradeoffs as the cost of maturity.

**[NanoClaw](https://github.com/qwibitai/nanoclaw) ⭐ 30,720 | 🐛 1,095 | 🌐 TypeScript | 📅 2026-09-08** — Python, mandatory container isolation, \~700 lines (auditable in an afternoon). Choose when: security and auditability matter more than skill count. Regulated environments.

**[ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw) ⭐ 32,743 | 🐛 807 | 🌐 Rust | 📅 2026-09-08** — Rust, 3.4MB binary, <10ms startup, 7.8MB RAM (194× smaller than OC), direct OpenClaw config import, 22+ providers. Choose when: resource efficiency matters, or you want a migration path from OpenClaw.
...
**[PicoClaw](https://github.com/sipeed/picoclaw) ⭐ 29,941 | 🐛 53 | 🌐 Go | 📅 2026-09-03** — Go, <10MB RAM, 1-second startup, targets $10 RISC-V hardware. Choose when: IoT, home automation, embedded Linux, cheapest possible hardware.

**[Nanobot](https://github.com/HKUDS/nanobot) ⭐ 47,877 | 🐛 767 | 🌐 Python | 📅 2026-09-08** — Python, \~4,000 lines, maximum readability, MCP-only tools. Choose when: learning agent internals, prototyping architectures, academic research.

**[NullClaw](https://github.com/nullclaw/nullclaw) ⭐ 8,070 | 🐛 94 | 🌐 Zig | 📅 2026-07-19** — Zig, 1MB RAM, 678KB binary. Choose when: absolute minimal footprint, microcontroller-adjacent.
...
| [Carapace](https://github.com/carapace-sh/carapace) ⭐ 1,432 \| 🐛 51 \| 🌐 Go \| 📅 2026-09-06 | Various  | Governance/compliance first            |
...
* [Nanobot](https://github.com/HKUDS/nanobot) ⭐ 47,877 | 🐛 767 | 🌐 Python | 📅 2026-09-08 — Best platform for studying agent internals; easy to instrument
...
* [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) ⭐ 31,670 | 🐛 78 | 📅 2026-03-24 — The definitive use case collection
...
| Channel                                                                                                              | Description                                              |
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 389,186 \| 🐛 6,355 \| 🌐 TypeScript \| 📅 2026-09-08 | Bug reports, feature feedback, CVE disclosures           |
...
| List                                                                                                                                 | Scope                                                |
| ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------- |
| [VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,439 \| 🐛 5 \| 📅 2026-09-05          | 5,400+ curated skills — the specialized skills index |
| [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) ⭐ 31,670 \| 🐛 78 \| 📅 2026-03-24 | Real-world use cases by domain                       |
| [vincentkoc/awesome-openclaw](https://github.com/vincentkoc/awesome-openclaw) ⭐ 145 \| 🐛 60 \| 📅 2026-04-20                        | General community list                               |
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 94,606 \| 🐛 2,890 \| 📅 2026-09-07                         | Full MCP ecosystem                                   |
| [awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) ⭐ 29,927 \| 🐛 1,004 \| 📅 2026-08-21                              | Broader AI agent landscape                           |
| [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 136,602 \| 🐛 11 \| 🌐 Python \| 📅 2026-09-08                | LLM application patterns                             |
| [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 317,851 \| 🐛 0 \| 📅 2026-09-06                    | Self-hosting ecosystem                               |
