...
| --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) ⭐ 390,237 \| 🐛 8,324 \| 🌐 TypeScript \| 📅 2026-09-22           | Main repository — TypeScript monorepo                                     |
...
| [OpenClaw Changelog](https://github.com/openclaw/openclaw/releases) ⭐ 390,237 \| 🐛 8,324 \| 🌐 TypeScript \| 📅 2026-09-22 | Release notes and version history                                         |
...
➡️ [**VoltAgent/awesome-openclaw-skills**](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,718 | 🐛 2 | 📅 2026-09-22 — 1M+ monthly views, the #1 community skills resource.
...
* [SKILL.md Format Specification](https://github.com/openclaw/clawhub/blob/main/docs/skill-format.md) ⭐ 9,441 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-22 — frontmatter fields, env var declarations, binary dependencies, install spec
* [ClawHub CLI Publishing Tool](https://github.com/openclaw/clawhub) ⭐ 9,441 | 🐛 75 | 🌐 TypeScript | 📅 2026-09-22 — `clawhub publish <path>`, `clawhub inspect <slug>`, versioning, soft-delete/restore
...
| ----------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------- |
| [playwright-mcp](https://github.com/microsoft/playwright-mcp) ⭐ 37,465 \| 🐛 5 \| 🌐 TypeScript \| 📅 2026-09-18                                | Browser  | Most-used MCP in OpenClaw; full browser automation |
| [github-mcp](https://github.com/github/github-mcp-server) ⭐ 33,121 \| 🐛 338 \| 🌐 Go \| 📅 2026-09-21                                          | DevOps   | Official GitHub MCP                                |
| [filesystem-mcp](https://github.com/modelcontextprotocol/servers/tree/main/src/filesystem) ⭐ 90,546 \| 🐛 547 \| 🌐 TypeScript \| 📅 2026-09-03 | System   | Read/write files with explicit path control        |
| [memory-mcp](https://github.com/JamesANZ/memory-mcp) ⭐ 21 \| 🐛 0 \| 🌐 TypeScript \| 📅 2025-12-10                                             | Memory   | Knowledge graph memory                             |
| [brave-search-mcp](https://github.com/brave/brave-search-mcp-server) ⭐ 1,458 \| 🐛 42 \| 🌐 TypeScript \| 📅 2026-09-17                         | Search   | Web search via Brave API                           |
| [fetch-mcp](https://github.com/zcaceres/fetch-mcp) ⭐ 827 \| 🐛 7 \| 🌐 TypeScript \| 📅 2026-03-12                                              | HTTP     | Web fetching and scraping                          |
| [postgres-mcp](https://github.com/crystaldba/postgres-mcp) ⭐ 3,332 \| 🐛 92 \| 🌐 Python \| 📅 2026-08-17                                       | Database | Read-only PostgreSQL access                        |
| [slack-mcp](https://mcp.slack.com)                                                                                                              | Comms    | Official Slack MCP                                 |
| [gmail-mcp](https://gmail.mcp.claude.com)                                                                                                       | Email    | Gmail via MCP                                      |

Browse 13,000+ MCP servers at [mcp.so](https://mcp.so) or the [official MCP server directory](https://github.com/modelcontextprotocol/servers) ⭐ 90,546 | 🐛 547 | 🌐 TypeScript | 📅 2026-09-03.
...
| [OpenClaw Windows Hub](https://github.com/openclaw/openclaw-windows-node) ⭐ 2,124 \| 🐛 112 \| 🌐 C# \| 📅 2026-09-22 | Windows         | Windows companion suite for OpenClaw (AI personal assistant)                                                   |
...
| [OpenClaw Android Node](https://docs.openclaw.ai/platforms/android) | Android  | Official Android platform docs; community APK build at [openclaw-android-node-apk](https://github.com/bighamx/openclaw-android-node-apk) ⭐ 58 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-09-22                                                                              |
...
See [nix-openclaw](https://github.com/openclaw/nix-openclaw) ⭐ 710 | 🐛 2 | 🌐 Nix | 📅 2026-09-21 for the community NixOS module.
...
| [NemoClaw](https://github.com/nvidia/nemoclaw) ⭐ 22,515 \| 🐛 728 \| 🌐 TypeScript \| 📅 2026-09-22    | NVIDIA-sandboxed build; GPU-accelerated, fully isolated   | Air-gap ready            |
...
| [Graphiti](https://github.com/getzep/graphiti) ⭐ 31,071 \| 🐛 500 \| 🌐 Python \| 📅 2026-09-21 | Temporal knowledge graph memory              | Complex relational knowledge over time       |
| [MemOS](https://github.com/MemTensor/MemOS) ⭐ 11,525 \| 🐛 90 \| 🌐 TypeScript \| 📅 2026-09-22 | Hierarchical memory OS for LLM agents        | Research-grade memory architecture           |
| [mem0](https://github.com/mem0ai/mem0) ⭐ 65,822 \| 🐛 766 \| 🌐 Python \| 📅 2026-09-21         | Self-improving personalized memory           | Personalization-heavy workflows              |
...
| Resource                                                                                               | Description                                                                                                                   |
| ------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| [A2A Protocol Spec](https://github.com/a2aproject/A2A) ⭐ 25,888 \| 🐛 262 \| 🌐 Shell \| 📅 2026-09-21 | Open agent interoperability protocol, initiated by Google                                                                     |
...
| [ClawHub CLI](https://github.com/openclaw/clawhub) ⭐ 9,441 \| 🐛 75 \| 🌐 TypeScript \| 📅 2026-09-22 | Official publishing tool: `clawhub publish`, `clawhub inspect`, versioning, soft-delete/restore                                                |
...
| Tool                                                                                                     | Description                                                                                                                                                                         |
| -------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ClawRouter](https://github.com/BlockRunAI/ClawRouter) ⭐ 6,611 \| 🐛 4 \| 🌐 TypeScript \| 📅 2026-09-21 | Agent-native LLM router supporting 41+ models, sub-1ms routing latency, USDC payments via x402 on Base and Solana                                                                   |
...
**[OpenClaw](https://github.com/openclaw/openclaw) ⭐ 390,237 | 🐛 8,324 | 🌐 TypeScript | 📅 2026-09-22** — Reference implementation. Choose when: you want the largest skill ecosystem and accept the resource tradeoffs as the cost of maturity.

**[NanoClaw](https://github.com/qwibitai/nanoclaw) ⭐ 30,823 | 🐛 1,067 | 🌐 TypeScript | 📅 2026-09-22** — Python, mandatory container isolation, \~700 lines (auditable in an afternoon). Choose when: security and auditability matter more than skill count. Regulated environments.

**[ZeroClaw](https://github.com/zeroclaw-labs/zeroclaw) ⭐ 32,857 | 🐛 762 | 🌐 Rust | 📅 2026-09-22** — Rust, 3.4MB binary, <10ms startup, 7.8MB RAM (194× smaller than OC), direct OpenClaw config import, 22+ providers. Choose when: resource efficiency matters, or you want a migration path from OpenClaw.

**[Moltis](https://github.com/moltis-org/moltis) ⭐ 2,869 | 🐛 95 | 🌐 Rust | 📅 2026-09-18** — A trusted Rust-native Claw. One binary — sandboxed, secure, auditable. Built-in voice, memory, MCP tools and multi-channel access. Choose when: your team needs a trustworthy enterprise-grade Rust implementation.

**[PicoClaw](https://github.com/sipeed/picoclaw) ⭐ 30,009 | 🐛 37 | 🌐 Go | 📅 2026-09-17** — Go, <10MB RAM, 1-second startup, targets $10 RISC-V hardware. Choose when: IoT, home automation, embedded Linux, cheapest possible hardware.

**[Nanobot](https://github.com/HKUDS/nanobot) ⭐ 48,476 | 🐛 802 | 🌐 Python | 📅 2026-09-22** — Python, \~4,000 lines, maximum readability, MCP-only tools. Choose when: learning agent internals, prototyping architectures, academic research.
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,763 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21     | C        | ESP32 microcontroller version          |
| [Carapace](https://github.com/carapace-sh/carapace) ⭐ 1,443 \| 🐛 51 \| 🌐 Go \| 📅 2026-09-21 | Various  | Governance/compliance first            |
...
* [Nanobot](https://github.com/HKUDS/nanobot) ⭐ 48,476 | 🐛 802 | 🌐 Python | 📅 2026-09-22 — Best platform for studying agent internals; easy to instrument
...
* [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) ⭐ 31,671 | 🐛 77 | 📅 2026-03-24 — The definitive use case collection
...
| Channel                                                                                                              | Description                                              |
| -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 390,237 \| 🐛 8,324 \| 🌐 TypeScript \| 📅 2026-09-22 | Bug reports, feature feedback, CVE disclosures           |
...
| List                                                                                                                                 | Scope                                                |
| ------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------- |
| [VoltAgent/awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,718 \| 🐛 2 \| 📅 2026-09-22          | 5,400+ curated skills — the specialized skills index |
| [hesamsheikh/awesome-openclaw-usecases](https://github.com/hesamsheikh/awesome-openclaw-usecases) ⭐ 31,671 \| 🐛 77 \| 📅 2026-03-24 | Real-world use cases by domain                       |
| [vincentkoc/awesome-openclaw](https://github.com/vincentkoc/awesome-openclaw) ⭐ 143 \| 🐛 63 \| 📅 2026-04-20                        | General community list                               |
| [awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) ⭐ 95,413 \| 🐛 2,193 \| 📅 2026-09-21                         | Full MCP ecosystem                                   |
| [awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) ⭐ 30,115 \| 🐛 1,057 \| 📅 2026-08-21                              | Broader AI agent landscape                           |
| [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) ⭐ 139,379 \| 🐛 17 \| 🌐 Python \| 📅 2026-09-22                | LLM application patterns                             |
| [awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ⭐ 320,922 \| 🐛 0 \| 📅 2026-09-21                    | Self-hosting ecosystem                               |
